...
Neo4j standardno eksponira dva glavna porta za komunikaciju i rad s bazom:
1. Port 7474 (HTTP) - Služi za pristup Neo4j Browseru, odnosno vizualnom web sučelju baze podataka. Kroz ovaj port u pregledniku (na adresi `http://localhost:7474`) pišemo Cypher upite, upravljamo bazom i vizualiziramo grafove.
2. Port 7687 (Bolt) - Služi za Bolt protokol, što je binarni protokol visokih performansi koji koriste aplikacijski programski driveri. Preko ovog porta aplikacije pisane u jezicima kao što su Python, Java, JavaScript ili C# direktno komuniciraju i razmjenjuju podatke s Neo4j bazom.
